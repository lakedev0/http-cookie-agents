...
import { CookieAgent } from 'http-cookie-agents/undici';
...
import { CookieJar } from 'tough-cookie';
import { HttpsCookieAgent } from 'http-cookie-agents/http';
...
:warning: `got` supports cookies by default. You may not need `http-cookie-agents`.
